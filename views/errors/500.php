...
<head>
    ...
    <title>Error del servidor — <?= defined('SITE_NAME') ? SITE_NAME : 'Regalos Purranque' ?></title>
    <style>
        ...
        .error h1 { font-size: 6rem; margin: 0; color: #d97706; font-weight: 800; }
...
<body>
    <div class="error">
        ...
        <p>Lo sentimos, ha ocurrido un error inesperado. Estamos trabajando en solucionarlo.</p>

...
class FechaController extends Controller
{
    ...
    public function index(): void
    {
        ...
        $this->render('public/celebraciones', [
            ...
            'keywords'          => 'celebraciones purranque, fechas especiales purranque, regalos purranque, ofertas purranque',
    ...
    public function show(string $slug): void
    {
        ...
        $this->render('public/fecha', [
            ...
            'og_image'    => asset('img/og/fecha-default.jpg'),
            'keywords'    => $fecha['nombre'] . ' purranque, regalos ' . strtolower($fecha['nombre']) . ', comercios purranque',
            'fecha'       => $fecha,
            'comercios'   => $comercios,
            'banners'     => $banners,
            'total'       => $total,
